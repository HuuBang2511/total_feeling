...
/* @var $searchModel app\modules\quanly\models\caphe\RuongbacthangSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : 'Ruộng bậc thang';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="ruongbacthang-index">

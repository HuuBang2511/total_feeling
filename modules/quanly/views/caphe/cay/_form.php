...
<div class="block block-themed">
    ...
    <div class="block-content">
        ...
        <div class="row mt-3">
            <div class="col-lg-12">
                <?= $form->field($model, 'nguongoc')->textInput(['maxlength' => true]) ?>
            </div>
        </div>
        ...
        <h3 class="content-heading">Sinh khối</h3>
        ...
        <div class="row mt-3">
            ...
            <div class="col-lg-3">
                <?= $form->field($model, 'duongkinhthan')->textInput(['maxlength' => true]) ?>
            </div>
            <div class="col-lg-3">
                <?= $form->field($model, 'duongkinhtan')->textInput(['maxlength' => true]) ?>
            </div>
            <div class="col-lg-3">
                <?= $form->field($model, 'loaire')->textInput(['maxlength' => true]) ?>
            </div>
        ...
        <div class="row mt-3">
            <div class="col-lg-12">
                <?= $form->field($model, 'khanang_giudat')->textArea(['rows' => 4]) ?>
            </div>
        </div>

        <div class="row mt-3">
            <div class="col-lg-12">
                <?= $form->field($model, 'ghichu_sinhkhoi')->textArea(['rows' => 4]) ?>
            </div>
        </div>

...
/* @var $searchModel app\modules\quanly\models\caphe\CayChuoiDaTrongSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : 'Cây chuối đã trồng';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="cay-chuoi-da-trong-index">

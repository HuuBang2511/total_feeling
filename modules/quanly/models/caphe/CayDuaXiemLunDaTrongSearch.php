...
/**
 * CayDuaXiemLunDaTrongSearch represents the model behind the search form about `app\modules\quanly\models\caphe\CayDuaXiemLunDaTrong`.
 */
class CayDuaXiemLunDaTrongSearch extends CayDuaXiemLunDaTrong
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = CayDuaXiemLunDaTrong::find()->where(['status' => 1]);

...
/**
 * CayBangLangDaTrongSearch represents the model behind the search form about `app\modules\quanly\models\caphe\CayBangLangDaTrong`.
 */
class CayBangLangDaTrongSearch extends CayBangLangDaTrong
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = CayBangLangDaTrong::find()->where(['status' => 1]);

...
/**
 * RuongbacthangSearch represents the model behind the search form about `app\modules\quanly\models\caphe\Ruongbacthang`.
 */
class RuongbacthangSearch extends Ruongbacthang
{
    /**
     * @inheritdoc
     */

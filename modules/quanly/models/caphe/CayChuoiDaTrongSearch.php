...
/**
 * CayChuoiDaTrongSearch represents the model behind the search form about `app\modules\quanly\models\caphe\CayChuoiDaTrong`.
 */
class CayChuoiDaTrongSearch extends CayChuoiDaTrong
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = CayChuoiDaTrong::find()->where(['status' => 1]);

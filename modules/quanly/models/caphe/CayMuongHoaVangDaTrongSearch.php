...
/**
 * CayMuongHoaVangDaTrongSearch represents the model behind the search form about `app\modules\quanly\models\caphe\CayMuongHoaVangDaTrong`.
 */
class CayMuongHoaVangDaTrongSearch extends CayMuongHoaVangDaTrong
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = CayMuongHoaVangDaTrong::find()->where(['status' => 1]);

...
use Yii;
use app\modules\quanly\models\caphe\CayDuaXiemLunDaTrong;
use app\modules\quanly\models\caphe\CayDuaXiemLunDaTrongSearch;
...
/**
 * CayDuaXiemLunDaTrongController implements the CRUD actions for CayDuaXiemLunDaTrong model.
 */
class CayDuaXiemLunDaTrongController extends QuanlyBaseController
{

    public $title = "Cây dừa xiêm lùn đã trồng";
    ...
    public function init(){
        parent::init();
            $this->const = [
            'title' => 'Cây dừa xiêm lùn đã trồng',
            'label' => [
                'index' => 'Danh sách',
                'create' => 'Thêm mới',
                'update' => 'Cập nhật',
    ...
    {
        $searchModel = new CayDuaXiemLunDaTrongSearch();
    ...
    public function actionCreate()
    {
        ...
        $model = new CayDuaXiemLunDaTrong();

        $table = '"cay_duaxiemlun_datrong"';
    ...
    /**
     * Finds the CayDuaXiemLunDaTrong model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CayDuaXiemLunDaTrong the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = CayDuaXiemLunDaTrong::findOne($id)) !== null) {
            return $model;
        } else {

...
use app\modules\quanly\models\caphe\CayTreTuQuyDaTrongSearch;
...
/**
 * CayTreTuQuyDaTrongController implements the CRUD actions for CayTreTuQuyDaTrong model.
 */
class CayTreTuQuyDaTrongController extends QuanlyBaseController
{

    public $title = "Cây tre tứ quý đã trồng";
    ...
    {
        $searchModel = new CayTreTuQuyDaTrongSearch();
    ...
    public function actionCreate()
    {
        ...
        $model = new CayTreTuQuyDaTrong();

        $table = '"cay_tretuquy_datrong"';
    ...
    /**
     * Finds the CayTreTuQuyDaTrong model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CayTreTuQuyDaTrong the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = CayTreTuQuyDaTrong::findOne($id)) !== null) {
            return $model;
        } else {

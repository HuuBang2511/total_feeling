...
use Yii;
use app\modules\quanly\models\caphe\Ruongbacthang;
use app\modules\quanly\models\caphe\RuongbacthangSearch;
...
/**
 * RuongbacthangController implements the CRUD actions for Ruongbacthang model.
 */
class RuongbacthangController extends QuanlyBaseController
{

    public $title = "Ruộng bậc thang";
    ...
    {
        $searchModel = new RuongbacthangSearch();
    ...
    public function actionView($id)
    {
        ...
        $geojson = Ruongbacthang::find()->select(['st_asgeojson(geom)'])->where(['id' => $id])->asArray()->one();
    ...
    /**
     * Finds the Ruongbacthang model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Ruongbacthang the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Ruongbacthang::findOne($id)) !== null) {
            return $model;
        } else {
